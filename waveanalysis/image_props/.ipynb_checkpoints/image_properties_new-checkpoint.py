...
def get_numpy_array_properties(image_path: str) -> dict:
    """
    Retrieves the properties of a numpy_array image.
    

    Args:
        image_path (str): The path to the numpy array.

    Returns:
        dict: A dictionary containing the properties of the numpy file.
            - num_channels (int): 1
            - num_frames (int): Time/dt
